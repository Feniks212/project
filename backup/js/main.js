...
document.addEventListener("DOMContentLoaded", event => {
  ...
  // plugins ON
  {
    ...
    if (bodyUpdate.classList.contains("home")) {
      ...
      animationForMap();
      loadeerMapReady();
    } else if (bodyUpdate.classList.contains("privacy")) {
      // custom scroll
      customScroll();
  ...
  function MapOption() {
    ...
    const templateMarker = [
      ...
      "<g>",
      "<g>",
      '<path fill="{{ colorOne }}" fill-opacity=".7" d="M6 12A6 6 0 1 0 6 0a6 6 0 0 0 0 12z"/>',
      "</g>",
      "<g>",
      ...
      (function(_thisPin, _marker) {
        ...
        $("#" + _thisPin[3]).on("mouseenter", function(e) {
          ...
          if (e.currentTarget) {
            $("#markerLayer img")
              .eq(thisTitle)
              .css("animation", "pulse 1.5s infinite ease-out");
